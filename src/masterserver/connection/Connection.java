...
public class Connection extends Thread {
	...
	public void tick() {
		try {
			...
			if(input.equals("login")){
			...
			} else if(input.equals("get_gameservers")){ // get_gameservers
				String output = "";
				if (loggedIn || guest) {
				...
				out.println(output);
			} else if (input.equals("get_leaderboard")) { // get_leadebord
				String output = "";
				if (loggedIn || guest) {
				...
				out.println(output);
			}  else if(input.equals("get_guest_access")){ // get_guest_access
					String output = "";
					...
					output += number;
					out.println(output);
				} else if(input.equals("sign_up")){ // sign_up
					String output = "";
